...
export const GUIAS_INSTALACAO: GuiaInstalacao[] = [
  {
    ...
    steps: [
      ...
      { path: '/InstalarAndroid-p2.gif', title: 'Abra o MatchPlace no Chrome' },
  ...
  },
  {
    ...
    steps: [
      ...
      { path: '/InstalarSafari-p2.gif', title: 'Abra o MatchPlace no Safari' },
  ...
  },
  {
    ...
    steps: [
      ...
      { path: '/InstalariPhoneG-p2.gif', title: 'Abra o MatchPlace no Chrome' },
